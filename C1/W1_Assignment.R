...
# The first column should be this vector (note the intentional repeated values): Dog, Cat, Fish, Fish, Lizard
# The second column should be this vector: Bread, Orange, Chocolate, Carrots, Milk
#### Write your code below:3

a = c("Dog", "Cat", "Fish", "Fish", "Lizard")
f = c("Bread", "Orange", "Chocolate", "Carrots", "Milk")
df = data.frame("Animals"=a,"Foods"=f)
df
...
df2 = read.csv("cces_sample_coursera.csv")
hist(df2$pid7)
